...
export declare namespace v1.skill.asr.annotationSets {
    /**
...
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface AnnotationSetMetadata {
        'name': string;
...
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface CreateAsrAnnotationSetRequestObject {
        'name': string;
    }
}
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface CreateAsrAnnotationSetResponse {
        'id': string;
    }
}
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface GetAsrAnnotationSetAnnotationsResponse {
...
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface ListASRAnnotationSetsResponse {
...
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface UpdateAsrAnnotationSetContentsPayload {
...
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface UpdateAsrAnnotationSetPropertiesRequestObject {
        'name': string;
    }
}
export declare namespace v1.skill.asr.evaluations {
    /**
     *
     * @interface
     */
...
export declare namespace v1.skill.asr.evaluations {
     ...
     * @interface
     */
    interface EvaluationMetadataResult {
...
export declare namespace v1.skill.asr.evaluations {
     ...
     * @interface
     */
    interface EvaluationResultOutput {
...
export declare namespace v1.skill.asr.evaluations {
     ...
     * @enum
     */
    type EvaluationResultStatus = 'PASSED' | 'FAILED';
}
export declare namespace v1.skill.asr.evaluations {
    /**
     ...
     * @enum
     */
    type EvaluationStatus = 'IN_PROGRESS' | 'COMPLETED' | 'FAILED';
}
export declare namespace v1.skill.asr.evaluations {
    /**
     ...
     * @interface
     */
    interface GetAsrEvaluationsResultsResponse {
...
export declare namespace v1.skill.asr.evaluations {
     ...
     * @interface
     */
    interface ListAsrEvaluationsResponse {
...
export declare namespace v1.skill.asr.evaluations {
     ...
     * @interface
     */
    interface PostAsrEvaluationsRequestObject {
...
export declare namespace v1.skill.asr.evaluations {
     ...
     * @interface
     */
    interface PostAsrEvaluationsResponseObject {
        'id': string;
    }
}
export declare namespace v1.skill.asr.evaluations {
...
export declare namespace v1.skill.interactionModel.conflictDetection {
    ...
    interface ConflictIntent {
        'name': string;
        'slots'?: {
            [key: string]: v1.skill.interactionModel.conflictDetection.ConflictIntentSlot;
        };
    }
}
export declare namespace v1.skill.interactionModel.conflictDetection {
...
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface AnnotationWithAudioAsset {
        'uploadId'?: string;
        'filePathInUpload'?: string;
        'evaluationWeight'?: number;
        'expectedTranscription'?: string;
...
export declare namespace v1.skill.asr.annotationSets {
     ...
     * @interface
     */
    interface GetASRAnnotationSetsPropertiesResponse {
        'name': string;
        'annotationCount': number;
        'lastUpdatedTimestamp': string;
        'eligibleForEvaluation'?: boolean;
...
export declare namespace v1.skill.asr.evaluations {
     ...
     * @interface
     */
    interface GetAsrEvaluationStatusResponseObject {
        'status': v1.skill.asr.evaluations.EvaluationStatus;
        'totalEvaluationCount': number;
        'completedEvaluationCount': number;
        'startTimestamp': string;
...
export declare namespace services.skillManagement {
    ...
    class SkillManagementServiceClient extends BaseServiceClient {
         ...
         */
        callGetAnnotationsForASRAnnotationSetV1(skillId: string, annotationSetId: string, accept: string, nextToken?: string, maxResults?: number): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         ...
         * @param {number} maxResults Sets the maximum number of results returned in the response body. Defaults to 1000. If more results are present, the response will contain a paginationContext.
         */
        getAnnotationsForASRAnnotationSetV1(skillId: string, annotationSetId: string, accept: string, nextToken?: string, maxResults?: number): Promise<v1.skill.asr.annotationSets.GetAsrAnnotationSetAnnotationsResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         ...
         */
        callSetAnnotationsForASRAnnotationSetV1(skillId: string, annotationSetId: string, updateAsrAnnotationSetContentsRequest: v1.skill.asr.annotationSets.UpdateAsrAnnotationSetContentsPayload): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         * @param {v1.skill.asr.annotationSets.UpdateAsrAnnotationSetContentsPayload} updateAsrAnnotationSetContentsRequest Payload containing annotation set contents. Two formats are accepted here: - &#x60;application/json&#x60;: Annotation set payload in JSON format. - &#x60;text/csv&#x60;: Annotation set payload in CSV format. Note that for CSV format, the first row should describe the column attributes. Columns should be delimited by comma.  The subsequent rows should describe annotation data and each annotation attributes has to follow the strict ordering defined in the first row. Each annotation fields should be delimited by comma.
         */
        setAnnotationsForASRAnnotationSetV1(skillId: string, annotationSetId: string, updateAsrAnnotationSetContentsRequest: v1.skill.asr.annotationSets.UpdateAsrAnnotationSetContentsPayload): Promise<void>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         */
        callDeleteASRAnnotationSetV1(skillId: string, annotationSetId: string): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         */
        deleteASRAnnotationSetV1(skillId: string, annotationSetId: string): Promise<void>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         */
        callGetASRAnnotationSetV1(skillId: string, annotationSetId: string): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         */
        getASRAnnotationSetV1(skillId: string, annotationSetId: string): Promise<v1.skill.asr.annotationSets.GetASRAnnotationSetsPropertiesResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         ...
         */
        callSetASRAnnotationSetV1(skillId: string, annotationSetId: string, updateAsrAnnotationSetPropertiesRequestV1: v1.skill.asr.annotationSets.UpdateAsrAnnotationSetPropertiesRequestObject): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} annotationSetId Identifier of the ASR annotation set.
         * @param {v1.skill.asr.annotationSets.UpdateAsrAnnotationSetPropertiesRequestObject} updateAsrAnnotationSetPropertiesRequestV1 Payload sent to the update ASR annotation set properties API.
         */
        setASRAnnotationSetV1(skillId: string, annotationSetId: string, updateAsrAnnotationSetPropertiesRequestV1: v1.skill.asr.annotationSets.UpdateAsrAnnotationSetPropertiesRequestObject): Promise<void>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} nextToken When response to this API call is truncated (that is, isTruncated response element value is true), the response also includes the nextToken element. The value of nextToken can be used in the next request as the continuation-token to list the next set of objects. The continuation token is an opaque value that Skill Management API understands. Token has expiry of 24 hours.
         * @param {number} maxResults Sets the maximum number of results returned in the response body. Defaults to 1000. If more results are present, the response will contain a paginationContext.
         */
        callListASRAnnotationSetsV1(skillId: string, nextToken?: string, maxResults?: number): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} nextToken When response to this API call is truncated (that is, isTruncated response element value is true), the response also includes the nextToken element. The value of nextToken can be used in the next request as the continuation-token to list the next set of objects. The continuation token is an opaque value that Skill Management API understands. Token has expiry of 24 hours.
         * @param {number} maxResults Sets the maximum number of results returned in the response body. Defaults to 1000. If more results are present, the response will contain a paginationContext.
         */
        listASRAnnotationSetsV1(skillId: string, nextToken?: string, maxResults?: number): Promise<v1.skill.asr.annotationSets.ListASRAnnotationSetsResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         ...
         */
        callCreateASRAnnotationSetV1(skillId: string, createAsrAnnotationSetRequest: v1.skill.asr.annotationSets.CreateAsrAnnotationSetRequestObject): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {v1.skill.asr.annotationSets.CreateAsrAnnotationSetRequestObject} createAsrAnnotationSetRequest Payload sent to the create ASR annotation set API.
         */
        createASRAnnotationSetV1(skillId: string, createAsrAnnotationSetRequest: v1.skill.asr.annotationSets.CreateAsrAnnotationSetRequestObject): Promise<v1.skill.asr.annotationSets.CreateAsrAnnotationSetResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} evaluationId Identifier of the evaluation.
         */
        callDeleteASREvaluationV1(skillId: string, evaluationId: string): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} evaluationId Identifier of the evaluation.
         */
        deleteASREvaluationV1(skillId: string, evaluationId: string): Promise<void>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} evaluationId Identifier of the evaluation.
         ...
         */
        callListASREvaluationsResultsV1(skillId: string, evaluationId: string, nextToken?: string, maxResults?: number, status?: string): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} evaluationId Identifier of the evaluation.
         ...
         * @param {string} status query parameter used to filter evaluation result status.   * &#x60;PASSED&#x60; - filter evaluation result status of &#x60;PASSED&#x60;   * &#x60;FAILED&#x60; - filter evaluation result status of &#x60;FAILED&#x60;
         */
        listASREvaluationsResultsV1(skillId: string, evaluationId: string, nextToken?: string, maxResults?: number, status?: string): Promise<v1.skill.asr.evaluations.GetAsrEvaluationsResultsResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} evaluationId Identifier of the evaluation.
         */
        callGetASREvaluationStatusV1(skillId: string, evaluationId: string): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} evaluationId Identifier of the evaluation.
         */
        getASREvaluationStatusV1(skillId: string, evaluationId: string): Promise<v1.skill.asr.evaluations.GetAsrEvaluationStatusResponseObject>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} nextToken When response to this API call is truncated (that is, isTruncated response element value is true), the response also includes the nextToken element. The value of nextToken can be used in the next request as the continuation-token to list the next set of objects. The continuation token is an opaque value that Skill Management API understands. Token has expiry of 24 hours.
         ...
         * @param {number} maxResults Sets the maximum number of results returned in the response body. Defaults to 1000. If more results are present, the response will contain a nextToken.
         */
        callListASREvaluationsV1(skillId: string, nextToken?: string, locale?: string, stage?: string, annotationSetId?: string, maxResults?: number): Promise<ApiResponse>;
        /**
         *
         * @param {string} skillId The skill ID.
         * @param {string} nextToken When response to this API call is truncated (that is, isTruncated response element value is true), the response also includes the nextToken element. The value of nextToken can be used in the next request as the continuation-token to list the next set of objects. The continuation token is an opaque value that Skill Management API understands. Token has expiry of 24 hours.
         ...
         * @param {number} maxResults Sets the maximum number of results returned in the response body. Defaults to 1000. If more results are present, the response will contain a nextToken.
         */
        listASREvaluationsV1(skillId: string, nextToken?: string, locale?: string, stage?: string, annotationSetId?: string, maxResults?: number): Promise<v1.skill.asr.evaluations.ListAsrEvaluationsResponse>;
        /**
         *
         ...
         * @param {string} skillId The skill ID.
         */
        callCreateASREvaluationV1(postAsrEvaluationsRequest: v1.skill.asr.evaluations.PostAsrEvaluationsRequestObject, skillId: string): Promise<ApiResponse>;
        /**
         *
         * @param {v1.skill.asr.evaluations.PostAsrEvaluationsRequestObject} postAsrEvaluationsRequest Payload sent to trigger evaluation run.
         * @param {string} skillId The skill ID.
         */
        createASREvaluationV1(postAsrEvaluationsRequest: v1.skill.asr.evaluations.PostAsrEvaluationsRequestObject, skillId: string): Promise<v1.skill.asr.evaluations.PostAsrEvaluationsResponseObject>;
        /**
         *
         * @param {string} skillId The skill ID.
         */
