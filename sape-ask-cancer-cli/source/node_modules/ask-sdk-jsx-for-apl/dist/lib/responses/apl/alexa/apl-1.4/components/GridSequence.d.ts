...
declare type scrollDirectionEnum = 'horizontal' | 'vertical';
declare type snapEnum = 'none' | 'start' | 'center' | 'end';
declare type Entity = {
    id: string;
    type: string;
    name: string;
...
declare type dimensionArray = dimension[] | string;
declare type anyArray = anyType[] | string;
declare type anyType = string | number | object;
...
export declare const GridSequence: (props: React.PropsWithChildren<GridSequenceProps>) => JSX.Element;
export {};
